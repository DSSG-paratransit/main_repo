...
Output: 
	If a second argument is passed the processed dataset is saved as a tab-delimed .csv file
...
numeric_list = ['LON','LAT']
integer_list = ['Activity','ETA','DwellTime']
data[numeric_list] = data[numeric_list].astype('float')
#data[integer_list] = data[integer_list].astype('int')
